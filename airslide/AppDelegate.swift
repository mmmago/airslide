        ...
        AppKit.NSEvent.addGlobalMonitorForEvents(matching: .leftMouseDragged) { [self] event in
            ...
            if self.mainScreen.frame.contains(mousePoint) == true  {
                ...
                if MBP14 {
                    ...
                    if (frontmostAppBundleIdentifier! == "com.apple.finder" || frontmostAppBundleIdentifier! == "mago.airslide") && self.filepath != "" { //So app only works on finder
                        
                        if mouseY >= (screenHeight! - statusBarHeight) - 12 && mouseX > 665 && mouseX < 850  {
                            
                            if mouseDraggedinNotch == false{
                                mouseDraggedinNotch = true
                            }
                            
                        }
                        else {
                            if mouseDraggedinNotch == true {
                    ...
                    if (frontmostAppBundleIdentifier! == "com.apple.finder" || frontmostAppBundleIdentifier! == "mago.airslide") && self.filepath != "" {
